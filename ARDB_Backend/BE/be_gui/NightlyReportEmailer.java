...
class NightlyReportEmailer extends ServicePanelInd {
	...
	private void emailCutChecks(){
		reportFileEmailer.sendEmailWithAttachment("blinds@mariettadrapery.com", "Cuts Shipped but not Billed", "This email was generated by a robot just for you Kenny, "
				+ "not witchcraft.", currentEditCheckPath, "MissedCuts.txt");
		
		reportFileEmailer.sendEmailWithAttachment("jedwards@mariettadrapery.com", "Cuts Shipped but not Billed", "This email was generated by a robot just for you Kenny, "
				+ "not witchcraft.", currentEditCheckPath, "MissedCuts.txt");
